...
import DvdBackground from "../components/DvdBackground"
...
export default function Page() {
  ...
  return (
    <main className="relative min-h-screen bg-gradient-to-br from-indigo-900 via-purple-800 to-gray-900 text-white">
      ...
      <motion.div
        ...
        ref={contentRef}
        className="relative z-10 max-w-4xl mx-auto p-10 mt-12 bg-white/10 backdrop-blur-2xl rounded-3xl shadow-2xl space-y-10"
      >
        {/* Header */}
        ...
        <section>
          ...
          <div className="flex flex-wrap gap-3 mt-4">
            {profileData.skills.map((s, i) => (
              <span
                key={i}
                className="px-4 py-2 rounded-full bg-gradient-to-r from-pink-500 to-purple-600 text-xs font-medium shadow-md"
              >
                {s}
              </span>
            ))}
